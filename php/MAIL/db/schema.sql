...
-- -----------------------------------------------------
-- Table `MAIL`.`Documents`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAIL`.`Documents` ;

CREATE TABLE IF NOT EXISTS `MAIL`.`Documents` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `mail_id` INT NULL,
  `no` VARCHAR(128) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NULL,
  `url` VARCHAR(1000) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NULL,
...
CREATE TABLE IF NOT EXISTS `MAIL`.`Recipients` (
  ...
  `reply` VARCHAR(1000) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NULL,
  `created_at` DATETIME NULL,
  `updated_at` DATETIME NULL,
  PRIMARY KEY (`id`),
